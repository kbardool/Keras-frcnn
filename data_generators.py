...
def get_anchor_gt(all_img_data,class_mapping,C):
	...
	while True:
		try:
			...
			for img_data in all_img_data:
				...
				img,img_data = data_augment.augment(img_data,C)
				...
				for idx,num_anchor_for_bbox in enumerate(num_anchors_for_bbox):
					if num_anchor_for_bbox == 0:
						...
						if best_anchor_for_bbox[idx] == 0:
							continue
						Y_is_box_valid[best_anchor_for_bbox[idx][0],best_anchor_for_bbox[idx][1],best_anchor_for_bbox[idx][2] + 3 * best_anchor_for_bbox[idx][3]] = 1
						Y_rpn_overlap[best_anchor_for_bbox[idx][0],best_anchor_for_bbox[idx][1],best_anchor_for_bbox[idx][2] + 3 * best_anchor_for_bbox[idx][3]] = 1
						Y_rpn_regr[best_anchor_for_bbox[idx][0],best_anchor_for_bbox[idx][1],4 * best_anchor_for_bbox[idx][2] + 4 * 3 * best_anchor_for_bbox[idx][3] + 0] = best_dx_for_bbox[idx][0]
						Y_rpn_regr[best_anchor_for_bbox[idx][0],best_anchor_for_bbox[idx][1],4 * best_anchor_for_bbox[idx][2] + 4 * 3 * best_anchor_for_bbox[idx][3] + 1] = best_dx_for_bbox[idx][1]
						Y_rpn_regr[best_anchor_for_bbox[idx][0],best_anchor_for_bbox[idx][1],4 * best_anchor_for_bbox[idx][2] + 4 * 3 * best_anchor_for_bbox[idx][3] + 2] = best_dx_for_bbox[idx][2]
						Y_rpn_regr[best_anchor_for_bbox[idx][0],best_anchor_for_bbox[idx][1],4 * best_anchor_for_bbox[idx][2] + 4 * 3 * best_anchor_for_bbox[idx][3] + 3] = best_dx_for_bbox[idx][3]
